...
<br>
**Thus, rude words are attacking the social injustice, but Hip-Pop music is all about love and peace.**
<br>
...
## Hip-Pop Changes, Eminem Doesn't? Nope!
...
<br>
**The plot below indicates Eminem's words usages among two decades. As we can see, Eminem's words pick almost didn't change. Based on pure data analysis, Eminem doesn't change among time. However, Hip-Pop industry as a whole doesn't change as well. So, *Nope* for the NY times Journalist.**
```{r fig.align='center', warning=FALSE}
timeless <- eminem %>% 
  mutate(decade = year - year%%10) %>% 
  mutate(token = str_split(stemmedwords, ' ')) %>% 
